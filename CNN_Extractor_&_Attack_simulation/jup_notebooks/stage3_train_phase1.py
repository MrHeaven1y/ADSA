...
class ForensicInfoNCELoss(nn.Module):
    ...
    def forward(self, pred_int, gt_int, pred_glob, gt_glob, z_mean, z_logvar, gt_latent, pred_fp, identity_labels, extractor, current_epoch=0, latent_weight=1.0, id_weight=1.0, collapse_weight=0.1, max_epochs=80, spatial_weight=1.0, global_weight=0.0):
            ...
            with sync_ctx:
                with autocast(device_type='cuda'):
                    ...
                    loss, bd = criterion(
                        ...
                        latent_weight=0.0, id_weight=0.0,
                        collapse_weight=0.0,
